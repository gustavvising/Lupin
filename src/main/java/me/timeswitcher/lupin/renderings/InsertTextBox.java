...
@OnlyIn(Dist.CLIENT)
public class InsertTextBox extends Widget implements IRenderable, IGuiEventListener {
	...
	public InsertTextBox(FontRenderer fontIn, int p_i51137_2_, int p_i51137_3_, int p_i51137_4_, int p_i51137_5_, String msg) {
		this(fontIn, p_i51137_2_, p_i51137_3_, p_i51137_4_, p_i51137_5_, (InsertTextBox)null, msg);
	}

	public InsertTextBox(FontRenderer fontIn, int xIn, int yIn, int widthIn, int heightIn, @Nullable InsertTextBox p_i51138_6_, String msg) {
	...
	public void renderButton(int p_renderButton_1_, int p_renderButton_2_, float p_renderButton_3_) {
		if (this.getVisible()) {
			if (this.getEnableBackgroundDrawing()) {
				fill(this.x - 1, this.y - 1, this.x + this.width + 1, this.y + this.height + 1, Color.WHITE.getRGB());
